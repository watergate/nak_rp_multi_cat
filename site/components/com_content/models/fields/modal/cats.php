...
class JFormFieldModal_Cats extends JFormField
{
  ...
  protected function loadInputTypeStandard()
    ...
    ?>
    <script src="<?php echo JUri::root().'components/com_multicats/helpers/jquery-ui-1.10.4.custom.min.js';?>" type="text/javascript"></script>
    <?php
    ...
    .catz img { float: left; padding: 0px; margin: 0px; width: 16px; height: 16px; margin-right: 5px; cursor: pointer;}
    ...
    $script[] = '        
      ...
      $cjq(document).ready(function($) {
        $cjq().ready(function() {  
          ...
          link	= "index.php?option=com_content&view=categories&extension=com_content&layout=cwmodal&tmpl=component&catz="+id+"&function=jSelectCategory_'.$this->id.'&'.JSession::getFormToken().'=1";
...
';
   	...
   	//$link	= 'index.php?option=com_categories&amp;view=categories&amp;extension=com_content&amp;layout=modal&amp;tmpl=component&amp;catz='.$this->value.'&amp;function=jSelectCategory_'.$this->id;
    $link	= 'index.php?option=com_content&amp;view=categories&amp;layout=cwmodal&amp;tmpl=component&amp;catz='.$this->value.'&amp;function=jSelectCategory_'.$this->id;
  ...
  j$(function () {
      ...
      j$("#search_cat").autocomplete({
          //source: "<?php echo JUri::root();?>components/com_multicats/helpers/assets/autocomplete.php",
...
<?php
    ...
    //if($titles != '') {} 
    $html[] = '  <div style="position: relative; margin-top: 5px; -webkit-border-radius: 5px; border-radius: 5px; display: block; border: 1px solid #d5d5d5; padding: 5px 10px 5px 10px; margin-bottom: 10px; " id="'.$this->id.'_title">';
